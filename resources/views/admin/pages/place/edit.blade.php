...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12">
        <div class="card">
        <form class="form-horizontal" method="post" action="{{route('places.update', $place->id)}}" enctype="multipart/form-data">
             {{ csrf_field() }}
             <input type="hidden" name="_method" value="put" />
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select class="select2 form-control custom-select" id="city" name="city_id"  style="width: 100%; height:36px;">
                                <option>Select</option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <select class="select2 form-control custom-select" id="subcategory" name="subcategory_id"  style="width: 100%; height:36px;">
                                <option>Select</option>
                                <optgroup label="Category List">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control" id="description" name="description" rows="3" cols="105"> {{$place->description}} </textarea>
                            <div class="error">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="phone_number" name="phone_number" value="{{$place->phone_number}}">
                            <div class="error">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="website" name="website" value="{{$place->website}}">
                            <div class="error">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="charges" name="charges" value="{{$place->charges}}">
                            <div class="error">
